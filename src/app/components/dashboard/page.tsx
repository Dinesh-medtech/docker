...
const App: React.FC = () => {
  ...
  //     const botResponse = responsesTyped[userMessage.toLowerCase()] || "I'm sorry, I don't understand that.";
  //     const newChatHistory = [...chatHistory, { sender: 'user', message: userMessage }, { sender: 'bot', message: botResponse }];
  //     setChatHistory(newChatHistory);
  //     setInputText('');
  //     setShowTitleAndTopics(false);

  //     const newConversation = { title: currentChatTitle || userMessage, history: newChatHistory };
            ...
            <>
              ...
              <div className={styles.topics}>
                {topics.map((topic, index) => (
                  <Chip key={index} label={topic} className={styles.chip} />
                ))}
              </div>
            </>
          )}
